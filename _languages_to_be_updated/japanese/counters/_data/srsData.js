// Configuration
const localStorageKey = "japanese" + "Counters" + "Srs";

// Display level
const displayLevel = "SRS Practice";

// Speech Synthesis
const language = "jp-JP";
...
const welcomeIntro = "In this spaced-repetition practice (SRS), you will recall the Japanese counters for hours, people, things and days. \n \n After your first session, you will also revise learned characters from previous sessions";
